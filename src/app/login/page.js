        ...
        <div className="flex w-full h-screen">
            ...
            <div className="flex w-full h-full text-center items-center justify-center">
                <div className="w-full max-w-lg flex flex-col gap-2">
                    <p className="font-bold text-3xl mb-5">Login</p>
                    {/* Email */}
                    <div className="mb-3">
                    ...
                    <Link href="#" className="inline-block self-end text-blue-600 hover:text-blue-800 pb-1 border-b-2 border-transparent hover:border-blue-800">
                        Forgot Password?
                    </Link>
                    {/* Confirm Button */}
                    ...
                    <div className="flex justify-center gap-1 mt-1">
                        ...
                        <Link href="/register" className="text-blue-600 hover:text-blue-900 border-b-2 border-transparent hover:border-blue-700">Click here</Link>
                    </div>
                </div>
            </div>
        </div>
