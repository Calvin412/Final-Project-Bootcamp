...
export default function AppBar() {
    return (
        <nav className="fixed inset-x-0 top-0 left-0 z-50 h-28 bg-white border-b border-gr ay-200 shadow-md">
            <div className="flex h-full items-center justify-between gap-4 px-4 sm:px-6 lg:px-10">
                {/* Logo */}
                <div className="flex items-center shrink-0">
                    <img src="logo.png" alt="Logo" className="h-auto max-w-56" />
                </div>
                <div className="flex flex-1 justify-end items-center">
                    ...
                    {/* Login Button */}
                    <Link href="/login" className="px-6 py-3 ml-5 rounded-md border-2 font-bold text-blue-600 border-blue-600 hover:bg-blue-800 hover:text-white">
                        Login
                    </Link>
                    {/* Register Button */}
                    <Link href="/register" className="px-6 py-3 ml-2 rounded-md bg-blue-600 text-white font-bold hover:bg-blue-800">
                        Register
                    </Link>
                    {/* Profile
