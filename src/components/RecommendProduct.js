                    ...
                    <CarouselContent>
                        <Link href="#" className="w-full max-w-80 shrink-0 overflow-hidden rounded-lg border border-gray-300 shadow-md mr-7">
                            <div className="flex justify-center border-b border-gray-400 bg-gray-100 p-7">
                                <img src="https://p3-ofp.static.pub//fes/cms/2024/10/30/owe4noysc71ah4qutx5htliga1bugf930316.png?width=1200&height=1200" alt="Product 1" className="max-h-32 max-w-32 object-contain" />
                            </div>
